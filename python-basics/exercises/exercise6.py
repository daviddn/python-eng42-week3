...
hero = input('Who is the hero of your story? ').capitalize()
villain = input('Who is the villain of your story? ').capitalize()
location = input('Where does the story take place? ').capitalize()
beg = input('Write out a sentence for the beginning of you story! ').capitalize()
mid = input('Write out a sentence for the middle of you story! ').capitalize()
end = input('Write out a sentence for the end of you story! ').capitalize()
